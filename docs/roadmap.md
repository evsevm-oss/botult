...
- [ ] Бизнес‑логика
  ...
  - [ ] Предпочтения/аллергии/диета из настроек — предупреждения при подтверждении (инициализировано: `/api/settings`)
...
- [ ] Логи и метрики
  - [ ] Сквозной trace_id; метрики: доля авто‑подтверждений, среднее число позиций, время нормализации (инициализация: метрики кэша)
- [ ] WebApp (дневник)
  - [x] Список приёмов за день, просмотр позиций, удаление (простое)
  - [ ] Редактирование и быстрое добавление, фильтр по датам (инициализировано)
