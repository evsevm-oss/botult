...
- [x] Стейт‑машина диалогов (заготовка для `/addmeal`), middlewares (логирование) — см. `bot/routers/meal.py`, `bot/middlewares/logging.py`
...
- [x] Frontend мини‑приложения: зарезервировано, будет на отдельном этапе (каркас указан в `docs/webapps-architecture.mdc`)
- [x] Обмен данными: REST каркас доступен (`infra/api/app.py`), синхронизация с ботом будет добавлена на следующих этапах
