...
Цель: создать бота, который помогает пользователю достигать целей по весу/жиру за счет подсчета калорий и макронутриентов, включая ввод по фото, и персональных рекомендаций AI-диетолога. На этом этапе исключаем тестирование и деплой.
