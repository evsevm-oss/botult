...
/**
 * Telegram WebApp — Главная — дизайн‑макет (stable revert)
 * -------------------------------------------------------------
 * Версия откатана до стабильной, компилируемой и запускаемой.
 * Сохранены: интерактивный «Дневник» (кликабельная дата,
 * стрелки назад/вперёд, модалки редактирования/удаления блюд),
 * верхние плитки (цель/калории/протеин/вес/жир), графики, калькулятор жира,
 * MainButton с плавным скроллом к «Дневнику».
 */
